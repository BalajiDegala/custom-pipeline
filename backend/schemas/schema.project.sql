...
-- Removed unique constraint to allow duplicate task names under the same folder
-- This enables assigning the same task type to different artists with different timelines
