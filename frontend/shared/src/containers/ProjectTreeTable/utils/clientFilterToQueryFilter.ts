...
export const clientFilterToQueryFilter = (filters: FilterForQuery[]): QueryFilter => {
  console.log('[clientFilterToQueryFilter] Input filters:', JSON.stringify(filters, null, 2))
  ...
  console.log('[clientFilterToQueryFilter] Output conditions:', JSON.stringify(conditions, null, 2))
